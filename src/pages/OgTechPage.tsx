        ...
        <section class="space-y-4">
          ...
          <div class="rounded-2xl border border-ink/15 bg-white/70 p-4 dark:border-white/15 dark:bg-[#182538]/75">
            ...
            <div class="mt-3 space-y-3">
              ...
              />
              <ToggleField label="Juno bundle" checked={junoBundle()} onChange={setJunoBundle} hint="+50% additive" />
              <ToggleField
          ...
          <div class="rounded-2xl border border-ink/15 bg-white/70 p-4 dark:border-white/15 dark:bg-[#182538]/75">
            ...
            >
              <div class="mt-3 grid gap-3 sm:grid-cols-2">
                <NumberField label="SE level" value={seLevel()} onInput={setSeLevel} step={1} />
                <NumberField label="Player level" value={playerLevel()} onInput={setPlayerLevel} step={1} />
                <NumberField label="DCM level" value={dcmLevel()} onInput={setDcmLevel} step={1} />
                <NumberField label="Research level" value={researchLevel()} onInput={setResearchLevel} step={1} />
                <ToggleField
                  ...
                  <article class="rounded-xl border border-ink/15 bg-white p-3 dark:border-white/15 dark:bg-[#23344d]">
                    ...
                    <div class="mt-3 grid grid-cols-[1fr_auto] items-end gap-2">
                      <NumberField
                        ...
                        onInput={(next) => setTechLevel(tech.id, parseNumberish(next))}
                        step={1}
                      />
                      <button
                        type="button"
